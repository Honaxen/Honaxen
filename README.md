...
| [document-agent](https://github.com/Honaxen/document-agent) | Conversational RAG agent — hybrid search (FAISS + BM25 + RRF), evaluation, FastAPI + Gradio + Docker | Ollama · FAISS · BM25 · FastAPI · Gradio |
